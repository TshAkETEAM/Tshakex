...
if (text and text == 'تفعيل المغادره') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
send(msg.chat_id_, msg.id_, 1, '☑┇تم تفعيل مغادره البوت', 1, 'md')
database:del('tshake:'..bot_id..'leave:groups')
end

if (text and text == 'تعطيل المغادره') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
if text == 'توجيه للكل' and tonumber(msg.reply_to_message_id_) > 0  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then  
...
-------------
if text == 'توجيه خاص' and tonumber(msg.reply_to_message_id_) > 0  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then  
...
if (not database:get('tshake:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
if text == "تنظيف المشتركين" and tonumber(sudo_add) == tonumber(msg.sender_user_id_) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local pv = database:smembers('tshake:'..bot_id.."userss")
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]
...
----------------
if text == "تنظيف الكروبات" and tonumber(sudo_add) == tonumber(msg.sender_user_id_) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local group = database:smembers('tshake:'..bot_id..'groups') 
local w = 0
local q = 0
for i = 1, #group do
...
if tonumber(sudo_add) == tonumber(msg.sender_user_id_) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
if text:match("^تحديث السورس$")  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
send(msg.chat_id_, msg.id_, 1, '☑️┇تم التحديث', 1, 'md')
os.execute('rm -rf ./libs/utils.lua')
os.execute('cd libs && wget https://raw.githubusercontent.com/TshAkETEAM/Tshakex/master/libs/utils.lua')
os.execute('rm -rf Tshake.lua')
...
if tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
if (msg.content_.text_ == 'الملفات' ) then
local files_tshake = database:smembers("files"..bot_id)
local keko = io.popen('cd files_tshake && ls'):read("*all")
local files_tshake2 = ''
...
if (text and text == 'مسح امر المطور بالكليشه') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
-----------------------------------------banall--------------------------------------------------
if text:match("^حظر عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) and msg.reply_to_message_id_ then
function gban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, result.sender_user_id_)
chat_kick(result.chat_id_, result.sender_user_id_)
...
if text:match("^حظر عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local apbll = {string.match(text, "^(حظر عام) @(.*)$")}
function gban_by_username(extra, result, success)
if result.id_ then
local hash =  'tshake:'..bot_id..'gbanned:'
...
if text:match("^حظر عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local apbll = {string.match(text, "^(حظر عام) (%d+)$")}
local hash =  'tshake:'..bot_id..'gbanned:'
database:sadd(hash, apbll[2])
tsX000(apbll[2],msg,"🚫┇تم حظره من المجموعات البوت")
end
if text:match("^الغاء العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) and msg.reply_to_message_id_ then
function ungban_by_reply(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
tsX000("prore",msg,"🚫┇تم الغاء حظره من المجموعات البوت")
database:srem(hash, result.sender_user_id_)
...
if text:match("^الغاء العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local apid = {string.match(text, "^(الغاء العام) @(.*)$")}
function ungban_by_username(extra, result, success)
local hash =  'tshake:'..bot_id..'gbanned:'
if result.id_ then
...
if text:match("^الغاء العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local apbll = {string.match(text, "^(الغاء العام) (%d+)$")}
local hash =  'tshake:'..bot_id..'gbanned:'
database:srem(hash, apbll[2])
tsX000(apbll[2],msg,"🚫┇تم الغاء حظره من مجموعات البوت")
...
if text:match("^كتم عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) and msg.reply_to_message_id_ then
...
if text:match("^كتم عام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^كتم عام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
if text:match("^الغاء كتم العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) and msg.reply_to_message_id_ then
...
if text:match("^الغاء كتم العام @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^الغاء كتم العام (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if  msg.content_.text_:match("^قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local hash =   'tshake:'..bot_id..'gbanned:'
local list = database:smembers(hash)
...
if  msg.content_.text_:match("^المكتومين عام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
local hash =   'tshake:'..bot_id..'gmuted:'
local list = database:smembers(hash)
...
if text:match("^مسح قائمه العام$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
text = '☑┇تم مسح قائمه العام'
database:del('tshake:'..bot_id..'gbanned:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
if text:match("^مسح المكتومين عام") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
if (text and text == 'حذف اسم البوت') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'تغير امر المطور بالكليشه') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
...
for k,v in pairs(sudo_users) do
if text:match("^تغير امر المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^اضف مطور$")  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^اضف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^اضف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) and msg.reply_to_message_id_ then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور @(.*)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text:match("^حذف مطور (%d+)$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
sendd(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتراك$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
sendd(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي معرف القناة') 
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
sendd(msg.chat_id_, msg.id_, '📮| حسنآ ارسل لي النص الذي تريده') 
return false  
end
if text == "حذف رساله الاشتراك" and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
database:del(bot_id..'text:ch:user')
sendd(msg.chat_id_, msg.id_, "📮| تم مسح رساله الاشتراك ") 
return false  
end
if text == "تفعيل الاشتراك الاجباري" and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري"  and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
sendd(msg.chat_id_, msg.id_, "📮| تم تعطيل الاشتراك الاجباري ") 
return false  
end
if text == "الاشتراك الاجباري" and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^اضف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
return false end
if text:match("^حذف رد للكل$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add)  or tonumber(msg.sender_user_id_) == tonumber(633004612) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ' , 1, 'md')
...
if text:match("^مسح المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^مسح ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text:match("^المطورين$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
local list = redis:smembers('tshake:'..bot_id..'dev')
text = "👨🏿‍💻 ┇ قائمه المطورين   ،\nꔹ┉♦️┉ ┉ ┉ ┉♦️┉ꔹ \n"
for k,v in pairs(list) do
local user_info = database:hgetall('tshake:'..bot_id..'user:'..v)
...
------------------------------------
if text:match("^ردود المطور$") and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
local list = redis:smembers('tshake:'..bot_id..'kekoresudo')
...
if  (text and text == 'تفعيل وضع المدفوع') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'تعطيل وضع المدفوع') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'تفعيل الاذاعه') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'تعطيل الاذاعه') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if text and text == "تعين مجموعه المطور" and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '☑┇ تم تعين ~⪼ `'..msg.chat_id_..'`', 1, 'md')
database:set("tshake"..bot_id..":sudo:gr",msg.chat_id_)
end
if text and text == "مسح مجموعه المطور" and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'استعاده الاوامر') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
...
if (text and text == 'تغير امر الاوامر') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م1') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م2') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م3') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if (text and text == 'تغير امر م4') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612)  then
send(msg.chat_id_, msg.id_, 1, '📥┇الان يمكنك ارسال الكليشه  ليتم حفظها', 1, 'html')
...
if text == 'مسح المكتومين عام 💠' and tonumber(msg.sender_user_id_) == tonumber(sudo_add) or tonumber(msg.sender_user_id_) == tonumber(633004612) then
text = '☑┇ تم مسح المكتومين عام'
database:del('tshake:'..bot_id..'gmuted:')
send(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
